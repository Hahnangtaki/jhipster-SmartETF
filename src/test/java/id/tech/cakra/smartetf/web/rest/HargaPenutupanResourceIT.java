...
public class HargaPenutupanResourceIT {
    ...
    private static final Double SMALLER_HARGA = 0D - 1D;
    ...
    public void setup() {
        ...
        final HargaPenutupanResource hargaPenutupanResource = new HargaPenutupanResource(hargaPenutupanRepository);
    ...
    public void createHargaPenutupan() throws Exception {
        ...
        assertThat(testHargaPenutupan.getKodeEfek()).isEqualTo(DEFAULT_KODE_EFEK);
    ...
    public void checkKodeEfekIsRequired() throws Exception {
        int databaseSizeBeforeTest = hargaPenutupanRepository.findAll().size();
        // set the field null
        hargaPenutupan.setKodeEfek(null);
    ...
    public void updateHargaPenutupan() throws Exception {
        ...
        assertThat(testHargaPenutupan.getKodeEfek()).isEqualTo(UPDATED_KODE_EFEK);
