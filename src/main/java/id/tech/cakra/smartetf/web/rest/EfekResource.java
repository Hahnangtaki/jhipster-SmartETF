...
/**
 * REST controller for managing {@link id.tech.cakra.smartetf.domain.Efek}.
 */
@RestController
@RequestMapping("/api")
public class EfekResource {
    ...
    public EfekResource(EfekRepository efekRepository) {
    ...
    public ResponseEntity<Efek> createEfek(@Valid @RequestBody Efek efek) throws URISyntaxException {
        ...
        Efek result = efekRepository.save(efek);
    ...
    public ResponseEntity<Efek> getEfek(@PathVariable Long id) {
        ...
        Optional<Efek> efek = efekRepository.findById(id);
